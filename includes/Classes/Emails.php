...
class Emails
{
    ...
    function __construct()
    {
		...
		$this->strings_new_client = array(
			'subject' => (get_option('email_new_client_by_user_subject_customize') == 1 && !empty(get_option('email_new_client_by_user_subject'))) ? get_option('email_new_client_by_user_subject') : __('Welcome to File-sharing Portal','cftp_admin'),
		...
		*/
		...
		$this->strings_new_user = array(
            'subject' => (get_option('email_new_user_subject_customize') == 1 && !empty(get_option('email_new_user_subject'))) ? get_option('email_new_user_subject') : __('Welcome to File-sharing portal','cftp_admin'),
			...
			'body3' => __('Thank you for using file-sharing portal.','cftp_admin'),
			'label_user' => __('Your username','cftp_admin'),
			'label_pass' => __('Your password','cftp_admin')
		);
