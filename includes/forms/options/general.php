...
<p class="text-warning"><?php _e('These options are to be changed only if you are moving the system to another place. Changes here can cause file-sharing system to stop working.','cftp_admin'); ?></p>
