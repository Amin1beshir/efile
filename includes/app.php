 ...
 *
 */
define('SYSTEM_NAME','File-Sharing Sytem');
define('SYSTEM_URI','https://10.240.1.78/');
define('SYSTEM_URI_LABEL','File-Sharing');
define('DONATIONS_URL','https://www.astu.edu.et/');
 ...
 */
define('NEWS_FEED_URI','https://www.astu.edu.et/latest/news');

/**
 * Define the Feed from where to take the latest version
 * number.
 */
define('UPDATES_FEED_URI','https://www.astu.edu.et/latest/news');
...
define('DEFAULT_LOGO_FILENAME', 'astu-logo.svg');
