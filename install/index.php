...
$install_no_baseuri		= __('File-Sharing URI was not completed.','cftp_admin');
    ...
    <div class="white-box">
        <div class="white-box-interior">
            ...
            ?>
                        ...
                        <p><?php _e('It seems that File-Sharing is already installed here.','cftp_admin'); ?></p>
                    ...
                    <?php
                            ...
                            switch ($query_state) {
                                case 'ok':
                                    ...
                                    if (!empty($create_errors) || !empty($chmod_errors) || $other_errors) {
                                        $msg = '<strong>' . __('Database installation was successful! Thank You, ','cftp_admin') . '</strong>';
                        ...
                        ?>
                            <form action="index.php" name="install_form" id="install_form" method="post" class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <label for="base_uri" class="col-sm-4 control-label"><?php _e('File-Sharing System URI (address)','cftp_admin'); ?></label>
                                    <div class="col-sm-8">
